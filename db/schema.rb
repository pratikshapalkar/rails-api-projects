...
ActiveRecord::Schema.define(version: 2022_03_09_102415) do
  ...
  create_table "data_decryptions", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "data_encryptions", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
